var utils = require('./utils'),
  ...
  iterateFilter = require('../packages/swig-core/lib/filters').iterateFilter;

/**
 * Phase 1 carve — `iterateFilter` moved to @rhinostone/swig-core. The
 * local binding above keeps every filter's call-site
 * (`iterateFilter.apply(exports.myFilter, arguments)`) unchanged. The
 * relative-path require stays browserify@2-safe; scoped-package
 * resolution is #T18. See .claude/architecture/multi-flavor-ir.md.
 */

...
exports.compile = function (compiler, args) {
  // args is [target, op, ...valueFragments] per the parse handler below.
  // Target and value are carried as transitional string fragments — the
  // backend emits `<target> <op> <value>;` verbatim (see IRSet typedef).
  return ir.set(args[0], args[1], args.slice(2).join(' '));
};
